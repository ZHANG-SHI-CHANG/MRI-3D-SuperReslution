...
if __name__=='__main__':
    ...
    for i,datas_path in enumerate( glob.glob(os.path.join(input_paths,'*.nrrd')) ):
        input_name = datas_path.split('/')[-1][:-5]
        ...
        nrrd.write(os.path.join(output_paths,input_name+'_up4_to_original.nrrd'),result,options=original_options)